                ...
                <div className="preview-content">
                  ...
                  <div className="tags-preview">
                    {tags.length > 0 ? tags.map((tag, index) => (
                      ...
                      <span className="preview-tag">#sample #tags</span>
                    )}
                  </div>
                  <div className="media-placeholder">
                    {imagePreview || contentURL ? (
                      <div className="media-content">
                        ...
                        {contentURL && (
                          <iframe src={getEmbedURL(contentURL)} title="Content" frameBorder="0" allowFullScreen />
                        )}
                      </div>
                    ) : (
                      <div className="placeholder-text">Media Content</div>
                    )}
                  </div>
                </div>
              </div>
                ...
                <div className="split-layout">
                  <div className="media-section">
                    {(imagePreview || contentURL) ? (
                      ...
                      <div className="placeholder-text">Media Section</div>
                    )}
                  </div>
                ...
                <div className="modern-stack">
                  <div className="hero-section">
                    {(imagePreview || contentURL) ? (
                      ...
                      <div className="placeholder-text">Featured Media</div>
                    )}
        ...
        <div className="form-section">
          <div className="auth-content form-side">
            <div className="login-content">
              <h1 className="auth-heading">Create Learning Plan</h1>
              <p className="auth-subheading">Share your learning journey</p>
            </div>

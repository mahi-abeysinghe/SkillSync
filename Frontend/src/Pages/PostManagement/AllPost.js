...
import { FaEdit, FaSearch, FaCommentAlt } from "react-icons/fa";
...
function AllPost() {
  ...
  const handleAddComment = async (postId) => {
    ...
    try {
      ...
      // Show notification
      showNotification('comment', 'Comment added successfully!');
    } catch (error) {
  ...
  const handleDeleteComment = async (postId, commentId) => {
    ...
    try {
      ...
      // Show notification
      showNotification('delete', 'Comment deleted successfully!');
    } catch (error) {
  ...
  const handleSaveComment = async (postId, commentId, content) => {
    try {
      ...
      // Show notification
      showNotification('update', 'Comment updated successfully!');
    } catch (error) {
    ...
    <div className={`auth-container ${darkMode ? 'dark-mode' : ''}`}>
      ...
      {commentSuccess && (
        <div className="notification-toast success-toast">
          <i className="fas fa-check-circle notification-icon"></i>
          {notificationMessage}
        </div>
      )}
      
      {deleteSuccess && (
        <div className="notification-toast delete-toast">
          <i className="fas fa-trash-alt notification-icon"></i>
          {notificationMessage}
        </div>
      )}
      
      {updateSuccess && (
        <div className="notification-toast update-toast">
          <i className="fas fa-edit notification-icon"></i>
          {notificationMessage}
        </div>
      )}
    </div>
